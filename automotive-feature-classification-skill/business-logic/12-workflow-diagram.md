...
flowchart TD
    ...
    ACT -- no --> R4["Rule 4 — Silent-all<br/>Presence = No Information Found<br/>Status = Unable to Decide<br/>Classification = Empty<br/>Traceability = 0 blocks"]
...
flowchart TD
    ...
    E6["All sources silent on parameter"] --> E6R4["Rule 4<br/>Unable to Decide / No Information Found / Empty<br/>(no traceability blocks)"]
