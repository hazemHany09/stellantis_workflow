...
| :--------------------- | :----------------------------------------------------------------------------- | :-------------------- |
| `Yes`                  | Rule 1 (Success-present), Rule 2a (level conflict), Rule 3 (vague-only)        | `10-decision-rules.md` |
| `No`                   | Rule 5 (Success-absent, explicit negative agreement)                           | `10-decision-rules.md` |
| `Disputed`             | Rule 2b only — clear sources disagree on whether feature exists                | `10-decision-rules.md`, Q-HARN-6 |
...
| Value              | When used                            | Source                |
| :----------------- | :----------------------------------- | :-------------------- |
| `Success`          | Rule 1 (present + level) or Rule 5 (absent) | `10-decision-rules.md` |
| `Conflict`         | Rule 2a (level conflict) or Rule 2b (presence conflict) | `10-decision-rules.md`, Q-HARN-3-v2 |
| `Unable to Decide` | Rule 3 (vague-only) or Rule 4 (silent-all) | `10-decision-rules.md` |
...
| Value    | When used                                     | Source                |
| :------- | :-------------------------------------------- | :-------------------- |
| `High`   | Rule 1 + `High` in applicable set             | `02-parameters-and-levels.md` |
| `Medium` | Rule 1 + `Medium` in applicable set           | `02-parameters-and-levels.md` |
| `Basic`  | Rule 1 + `Basic` in applicable set            | `02-parameters-and-levels.md` |
| `Empty`  | All non-Rule-1 records; also Rule 1 is impossible when applicable set would disallow the only-evidenced tier (see Q-HARN-4, Invariant 7) | `06-harness-interface.md` |
...
Source: `06-harness-interface.md`, Q-DEL-4.
...
Internal tag used by subagents and the consolidator to route each block to the correct cardinality rule in `09-deliverable.md`.
