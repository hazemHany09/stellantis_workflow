...
Per [`business-logic/11-assumptions.md`](../../business-logic/11-assumptions.md) AS-SCOPE-2 and Q-SCOPE-2, `artifacts/params.csv` is **developer-owned, frozen per run**, and injected into the agent workspace.
...
* Any required column from [`business-logic/02-parameters-and-levels.md`](../../business-logic/02-parameters-and-levels.md) is absent.
